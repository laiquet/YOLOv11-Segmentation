...
from helpers import (torch_distributed_zero_first, LoadImagesAndLabels, mixup, letterbox, xyn2xy, xywhn2xyxy, random_perspective,
                     xyxy2xywhn, augment_hsv, copy_paste, xyxy2xywh)
...
def polygons2masks_overlap(img_size, segments, downsample_ratio=1):
    ...
    masks = np.zeros((img_size[0] // downsample_ratio, 
...
class LoadImages:
    # YOLOv5 image/ dataloader, i.e. `python detect.py --source image.jpg/vid.mp4`
    ...
    def __next__(self):
        ...
        if self.transforms:
            ...
            im = letterbox(im0, self.img_size, stride=self.stride, auto=self.auto)[0]  # padded resize (preserves aspect ratio)
